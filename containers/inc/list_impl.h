...
// -----------------------------------------------------------------------------
template <typename T>
List<T>::List(const std::size_t size, const T& startValue) 
{
...
// -----------------------------------------------------------------------------
template <typename T>
std::size_t List<T>::size() const { return mySize; }
...
// -----------------------------------------------------------------------------
template <typename T>
bool List<T>::resize(const std::size_t newSize, const T& startValue) 
{
...
template <typename T>
template <typename... Values>
bool List<T>::copy(const Values&&... values) 
{
    clear();
...
template <typename T>
template <std::size_t NumValues>
void List<T>::assign(const T (&values)[NumValues], const std::size_t offset)
{
...
// -----------------------------------------------------------------------------
template <typename T>
void List<T>::Iterator::operator+= (const std::size_t numIncrements) 
{
...
// -----------------------------------------------------------------------------
template <typename T>
void List<T>::ConstIterator::operator+=(const std::size_t numIncrements) 
{
    for (std::size_t i{}; i < numIncrements; ++i) 
    {
        myNode = myNode->next;
...
// -----------------------------------------------------------------------------
template <typename T>
void List<T>::Node::destroy(Node* self) 
{ 
    delete self;
    self = nullptr;
}
